...
namespace DemoVs2017
{
    public class Program
    {
        ...
        public static void ConvertToCSharp()
        {
            ...
            DirectoryInfo cSharpLocation = new DirectoryInfo(@"\ApexSharp\DemoVs2017\CSharpClasses\");

            //// Convert APEX to C#
            if (apexLocation.Exists && cSharpLocation.Exists)
            {
                ApexSharpParser.ConvertToCSharp(apexLocation.FullName, cSharpLocation.FullName, "DemoVs2017.CSharpClasses");
            }
            else
            {
